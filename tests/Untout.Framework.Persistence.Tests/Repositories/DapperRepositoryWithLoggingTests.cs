...
public class DapperRepositoryWithLoggingTests
{
    ...
    public async Task GetAllAsync_LogsQueryAndResult()
    {
        ...
        _mockDapperExecutor.Setup(d => d.QueryAsync<TestEntity>(_mockConnection.Object, It.IsAny<CommandDefinition>()))
    ...
    public async Task GetByIdAsync_LogsQueryWithParametersAndResult()
    {
        ...
        _mockDapperExecutor.Setup(d => d.QuerySingleOrDefaultAsync<TestEntity>(_mockConnection.Object, It.IsAny<CommandDefinition>()))
    ...
    public async Task AddAsync_LogsQueryAndInsertedId()
    {
        ...
        _mockDapperExecutor.Setup(d => d.ExecuteScalarAsync<int>(_mockConnection.Object, It.IsAny<CommandDefinition>()))
    ...
    public async Task UpdateAsync_LogsQueryAndAffectedRows()
    {
        ...
        _mockDapperExecutor.Setup(d => d.ExecuteAsync(_mockConnection.Object, It.IsAny<CommandDefinition>()))
            .ReturnsAsync(1);
